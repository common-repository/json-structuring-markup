...
*** Installing this plugin is the easiest way to add structured data to your posts. The plugin automatically creates the JSON-LD according to Google's specification. 
...
***Yes, Incase the fearuted image is not provided by the author so, the default provided image would be use. Else some of the schema's won't be validate the google structure data.***
